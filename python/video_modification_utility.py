...
import tempfile
import shutil
from moviepy import VideoFileClip, concatenate_videoclips  # TODO: add moviepy to requirements.txt
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Stitch together highlight clips using MoviePy.")
